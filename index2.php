...
<body>
	...
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_header">
			...
			<div id="header_right">
				<!-- top navigation bar -->
				<a href="account.php"><b>Welcome : <?php echo $_SESSION['id']; ?> My Account</b></a> | <a href="shoppingcart.php"><b>My Cart</b></a> | <a href="checkout.php"><b>Checkout</b></a> | <a href="logout.php"> <b>Log Out</b> </a>
			</div>
		...
		<div id="templatemo_menu">
			...
			<div id="menu_second_bar">
				...
				<div id="top_shopping_cart">
					...
					<!-- no of items added to the shopping cart-->
				</div>
					...
					<div class="details">
						...
						<div class="detail">
							...
							<h5 align="center" style="color: SlateGray  ;"><strong>
									...
									<br />
									<p style="color: maroon;">-----></p>paypal or 2checkout
								</strong></h5>
						</div>
		...
		<div id="templatemo_main">
			...
			<div id="content" class="float_r">
				...
				<?php
				if ($search) {
					$query = "select * from books where b_name like '%$search%' LIMIT 1,9";
				} else {
					$query = "select * from books LIMIT 1,9";
				}
