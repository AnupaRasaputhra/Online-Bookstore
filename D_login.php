...
<body>
	...
	<div class="content">
		...
		<div>
			<table>
				<form name="admin3" method="post" action="user.php">
					...
					<tr>
						...
						<td><input type="text" name="name3" /><br /></td>
					</tr>

					<tr>
						<td><label>E mail :</label></td>
						<td><input type="email" name="email3" /><br /></td>
					</tr>
					...
					<tr>
						<td colspan="4">
							...
							<input type="submit" name="deleteus" value="Delete" onclick="return confirm('continue delete??')" />
					</tr>
			...
			<div class="one">
				<?php
				$f = mysqli_query($con_str, "SELECT * FROM admin.login");
