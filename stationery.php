...
<head>
    <title>Online BookStore - Stationery Page</title>
    ...
    <div id="templatemo_wrapper">
        ...
        <div id="templatemo_main">
                ...
                <div class="sidebar_box"><span class="bottom"> </span>
                    ...
                    <div class="content">
                        <ul class="sidebar_list">
                            <li class="first"><a href="Office_Stationaries.php">Office_Stationaries</a></li><br />
                            <li><a href="School_Stationaries.php">School_Stationaries</a></li><br />
                            <!--<li><a href="English.php">English</a></li><br/>
                        <li><a href="#">Adult's</a></li><br/>
                        <li><a href="children.php">Children's</a></li><br/>
                        <li><a href="#">Novels</a></li><br/>-->
                        </ul>
                    </div>
                </div>
                <div class="sidebar_box"><span class="bottom"> </span>
            ...
            <div id="content" class="float_r">
                <h1>Office Suppliers</h1>
                <div class="product_box">
                    <a href="productdetail.html"><img src="images/product/ofs1.jpg" alt="Image 01" /></a>
                    <h3>sealer</h3>
                ...
                <div class="product_box">
                    <a href="productdetail.html"><img src="images/product/ofs2.jpg" alt="Image 02" /></a>
                    <h3>Hole Puncher</h3>
                    <p class="product_price">Rs:90</p>
                    <a href="shoppingcart.html" class="add_to_card">Add to Cart</a>
                    <a href="productdetail.html" class="detail">Detail</a>
                </div>
                <div class="product_box no_margin_right">
                    <a href="productdetail.html"><img src="images/product/ofs3.jpg" alt="Image 03" /></a>
                    <h3>paper Clips</h3>
                    <p class="product_price">Rs:120</p>
                    <a href="shoppingcart.html" class="add_to_card">Add to Cart</a>
                    <a href="productdetail.html" class="detail">Detail</a>
                </div>
                <div class="product_box">
                    <a href="productdetail.html"><img src="images/product/ofs4.jpg" alt="Image 04" /></a>
                    <h3>Binders</h3>
                ...
                <div class="product_box">
                    <a href="productdetail.html"><img src="images/product/ofs5.jpg" alt="Image 05" /></a>
                    <h3>Push Pins</h3>
                ...
                <div class="product_box no_margin_right">
                    <a href="productdetail.html"><img src="images/product/s5.jpg" alt="Image 06" /></a>
                    <h3>pen holders</h3>
                    <p class="product_price">Rs:50</p>
                    <a href="shoppingcart.html" class="add_to_card">Add to Cart</a>
                    <a href="productdetail.html" class="detail">Detail</a>
