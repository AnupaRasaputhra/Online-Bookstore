...
<div class="content">
		...
		<form name="admin4" method="post" action="contacts.php">
			...
			<td><input type="text" name="id4"/><br/></td></tr>
			
			
			<tr>
			<td><label>Contact Name :</label></td>
			<td><input type="text" name="name4"/><br/></td></tr>
			
			<tr>
			<td><label>E mail :</label></td>
			<td><input type="email" name="email4"/><br/></td></tr>
			
			<tr>
			<td><label>Contact-Query     :</label></td>
			<td><input type="text" name="query"/></td></tr><br/>
			
			
			<tr><td colspan="4">
			<input type="submit"  name="addc" value="Add" />
			<input type="submit" name="updatec" value="Update" onclick="return confirm('continue update??')"/>
			<input type="submit" name="deletec" value="Delete" onclick="return confirm('continue delete??')"/></tr>
			...
			<?php
	$f=mysql_query("SELECT * FROM admin.contacts");
